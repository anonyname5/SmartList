...
extension ItemQueryWhereSort on QueryBuilder<Item, Item, QWhere> {
  ...
  QueryBuilder<Item, Item, QAfterWhere> anyProjectId() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQueryWhere on QueryBuilder<Item, Item, QWhereClause> {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> projectIdEqualTo(int projectId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> projectIdGreaterThan(
    int projectId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> projectIdLessThan(
    int projectId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> projectIdBetween(
    int lowerProjectId,
    int upperProjectId, {
    bool includeLower = true,
    bool includeUpper = true,
